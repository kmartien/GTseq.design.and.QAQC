...
# for your dataset: customize the following paths
 sam.path <- "data-raw/sam.files/RunMS45.528locs"
 label.path <- "data-raw/mplot_labels/RunMS45.90s.label.txt"
 vcf.path <- "vcf/ddRAD.528locs.allSNPs.recode.vcf"
...
haplo.read.tbl <- prepHaplotFiles(run.label = paste0(run.label,".90s.528.allSNPs"),
                                  sam.path = sam.path,
                                  out.path = out.path,
