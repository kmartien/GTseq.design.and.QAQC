...
fastq.path <- "/Users/Shared/KKMDocuments/Documents/Karen/Structure/Humpbacks/Data/Fastq/RunMS58"
...
Miseq.num[which(fname.parts[,5] == "R2.fastq.gz")] <- Miseq.num[which(fname.parts[,5] == "R2.fastq.gz")] - 1
