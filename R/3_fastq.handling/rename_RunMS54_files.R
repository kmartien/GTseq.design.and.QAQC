...
fastq.path <- "/Users/Shared/KKMDocuments/Documents/Karen/Structure/Humpbacks/Data/Fastq/RunMS54"
...
#incomplete - waiting for Brittany to archive runs so that I can work with the correct names
